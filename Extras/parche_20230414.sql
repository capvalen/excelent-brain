...
CREATE TABLE `excelentemente`.`triaje` (`id` INT NOT NULL AUTO_INCREMENT , `patient_id` INT NOT NULL , `fecha` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , `motivo` TEXT NOT NULL , `sintomatologia` TEXT NOT NULL , `antecedentes` TEXT NOT NULL , `prioridad` INT NOT NULL , `especialista` VARCHAR(250) NOT NULL , `activo` TINYINT NOT NULL DEFAULT '1' , PRIMARY KEY (`id`)) ENGINE = InnoDB;
