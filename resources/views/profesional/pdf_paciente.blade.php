...
<head>
  ...
  <style>
    *{
    ...
    p {font-size: 16px; font-family:'Montserrat-Light'; color: #495057}
    ...
    .title-h1 {font-size: 22px; font-family:'Montserrat-Bold'; color: #6b61a6;}
    .title-h2 {font-size: 20px; font-family:'Montserrat-Bold'; color: #6b61a6;}
    .title-h3 {font-size: 19px; font-family:'Montserrat-Bold'; color: #6b61a6;}
    .title-h4 {font-size: 18px; font-family:'Montserrat-Bold'; color: #6b61a6;}
    .title-h5 {font-size: 16px; font-family:'Montserrat-Bold'; color: #6b61a6;}
    .title-h6 {font-size: 14px; font-family:'Montserrat-Bold'; color: #6b61a6;}

    .purple-color { color: #6b61a6; }
    .black-color { color: #495057; }

    .my-25 {padding-top: 25px; padding-bottom: 25px }
      ...
      <div class="px-50">
        ...
        <div>
          @if ( $historia->medical_evolutions ) 
            <div>
              <p class="title-h3 py-15">Evoluciones</p>
              ...
              <ul class="px-15">
                @foreach ($historia->medical_evolutions as $evolution)
                  ...
                  <div class="px-25">
                    <p class="title-h4 py-5">Contenido</p>
                    <p class="py-15"> 
                      {{ $evolution->content }}
                    </p>
                  </div>
