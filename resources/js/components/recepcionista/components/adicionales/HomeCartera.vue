...
export default{
	...
	components:{ModalCambiarSeguimiento},
	methods:{
		...
		queSeguimiento(item){ return this.seguimientos.find(x=> x.id == item).seguimiento },
		queColor(item){ return this.seguimientos.find(x=> x.id == item).color },
