...
{
    use HasFactory;
    protected $fillable=['date','type','patient_condition','link','mode','status','clasification','recomendation','professional_id','patient_id','schedule_id', 'formato_nuevo', 'byDoctor', 'idMembresia', 'recomendacion_comentario', 'num_sesion', 'attention', 'entrance', 'active_slot'];
